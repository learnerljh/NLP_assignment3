...
class CustomizedGPT2Attention(GPT2Attention):
    ...
    def forward(
        ...
        return outputs, present  # a, present, (attentions)
...
class CustomizedGPT2Block(GPT2Block):
    def __init__(self, config, layer_idx=None):
        ...
        attention_class = CustomizedGPT2Attention
    ...
    def forward(
        ...
        return outputs #, present  # hidden_states, present, (attentions, cross_attentions)
